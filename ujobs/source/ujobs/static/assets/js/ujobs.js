...
$(function () {
    ...
    // 编辑分发文件  删除隐藏域
    $(document).on("click", ".edit-sendfile-wrap .delete2", function () {
        var $parents = $(this).parents(".edit-sendfile-wrap");
        var send_file_hide = $parents.find(".edit-sendfile-hidelists");
        var e = $(this);
    ...
    // 分发文件  删除隐藏域
    $(document).on("click", "#send_file_form .delete2", function() {
        var send_file_hide = $("#send_file_remote_files_list");
        var e = $(this);
    ...
    // 编辑分发文件 删除隐藏域文件id
    $(document).on("click", ".edit-sendfile-wrap .delete1", function () {
        var $parents = $(this).parents(".edit-sendfile-wrap");
        var record = $parents.find(".edit_sendfile_record");
        var e = $(this);
    ...
    // 分发文件 删除隐藏域文件id
    $(document).on("click", "#send_file_form .delete1", function () {
        var record = $("#send_file_record_ids");
        var e = $(this);
