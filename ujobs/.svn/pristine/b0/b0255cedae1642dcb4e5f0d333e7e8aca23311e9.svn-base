...
def ajax_show_page_detail(request,history_step_id):
    ...
    result = {
        ...
        "step_start_time": history_step.start_time.strftime("%Y-%m-%d %H:%M:%S") if history_step.start_time else "",
        "step_finish_time": history_step.end_time.strftime("%Y-%m-%d %H:%M:%S") if history_step.end_time else "",
        "abnormal_ips": abnormal_ips,
        "total_ips": total_ips,
        "total_time": history.delta_time if history.delta_time else "",
        "step_total_time": history_step.delta_time if history_step.delta_time else "",
